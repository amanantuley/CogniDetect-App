...
/// A class that contains all theme configurations for the CogniDetect application.
/// Implements Clinical Minimalism design style with Therapeutic Blue Foundation color palette.
class AppTheme {
  AppTheme._();

  // Color Specifications - Therapeutic Blue Foundation
  // Primary colors
  static const Color primaryLight = Color(
    0xFF2E7D9A,
  ); // Trustworthy blue optimized for mobile screens
  static const Color primaryVariantLight = Color(
    0xFF4A90A4,
  ); // Supporting blue for secondary actions
  static const Color secondaryLight = Color(
    0xFF4A90A4,
  ); // Supporting blue for navigation elements
  static const Color secondaryVariantLight = Color(0xFF2E7D9A);
  static const Color accentLight = Color(
    0xFFF4A261,
  ); // Warm orange for positive feedback

  // Background and surface colors
  static const Color backgroundLight = Color(
    0xFFFAFBFC,
  ); // Soft off-white reduces eye strain
  ...
  static const Color errorLight = Color(
    0xFFE76F51,
  ); // Muted red-orange for supportive error states
  static const Color successLight = Color(
    0xFF2A9D8F,
  ); // Calming teal for positive results
  static const Color warningLight = Color(
    0xFFE9C46A,
  ); // Gentle yellow for attention states
  ...
  static const Color textMediumEmphasisLight = Color(0x996B7280); // 60% opacity
  static const Color textDisabledLight = Color(0x616B7280); // 38% opacity
  ...
  static const Color borderLight = Color(0xFFE5E7EB); // Subtle 1px borders
  static const Color dividerLight = Color(0xFFE5E7EB);

  // Shadow colors - minimal elevation
  static const Color shadowLight = Color(0x0F000000); // Subtle depth hierarchy

  // Dark theme colors
  static const Color primaryDark = Color(0xFF4A90A4);
  static const Color primaryVariantDark = Color(0xFF2E7D9A);
  static const Color secondaryDark = Color(0xFF4A90A4);
  static const Color secondaryVariantDark = Color(0xFF2E7D9A);
  ...
  /// Light theme - Clinical Minimalism with Therapeutic Blue Foundation
  static ThemeData lightTheme = ThemeData(
    ...
    cardTheme: CardThemeData(
      color: cardLight,
      elevation: 2.0, // Subtle elevation per Contemporary Elements
      shadowColor: shadowLight,
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        minimumSize: const Size(60, 60), // Minimum 60pt touch target
        shape: RoundedRectangleBorder(
  ...
  /// Dark theme - Clinical Minimalism with Therapeutic Blue Foundation
